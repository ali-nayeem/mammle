...
use warnings;
use Getopt::Long;
#use lib "/Users/ali_nayeem/Lib/paup"
use FindBin qw($Bin);
#use lib "$Bin/..";  # ei line ami block korsi
#use constants;
use File::Basename qw();
#print "$path\n";
#use constant PAUP => "/Users/ali_nayeem/NetBeansProjects/greedy-consensus/paup -n ";
#use constant PAUP => "/Users/ali_nayeem/NetBeansProjects/greedy-consensus/paup -n ";
#use constant PAUP => "/Users/ali_nayeem/NetBeansProjects/greedy-consensus/paup -n ";

#use constant PAUP => "/Users/ali_nayeem/Lib/paup -n ";
...
my ($name, $fpath, $suffix) = File::Basename::fileparse($0);
my $PAUP = $fpath . "paup -n ";
#print "$PAUP\n";
...
print "output at: $gre_file_newick\n";
print "done.\n";
...
sub run_paup {
 ...
 my $command = $PAUP . "$paup_file >/dev/null";
 system($command);
}
